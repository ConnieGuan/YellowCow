...
(function(window, document, undefined) {
     ...
     */
    function ColorPicker(slideElement, callback) {
        
        if (!(this instanceof ColorPicker)) return new ColorPicker(slideElement, callback);
        ...
        if (!callback) {
            ...
            ColorPicker.fixIndicators(slideIndicator);

            this.callback = function(hex, hsv, rgb, slideCoordinate) {

                ColorPicker.positionIndicators(slideIndicator, slideCoordinate);
